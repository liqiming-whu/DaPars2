...
def DaPars2_main():
    ...
    parser.add_argument('-w', '--wigfiles',dest="wigfiles", metavar="wigfiles", nargs="+", required=True, help='wig files generated by: "bedtools genomecov -ibam *.bam -bga -split -trackline"')
    parser.add_argument('-f', '--flagstat-files',dest="flagstat", metavar="flagstat", nargs="+", required=True, help='flagstat files generated by: "samtools flagstat *.bam", only pair-end support')
    parser.add_argument('-t', '--threads', dest="Num_threads", metavar="threads", type=int, default=4, help='Number of threads')
    parser.add_argument('-c', '--coverage', dest="Coverage_threshold", metavar="coverage_threshold", type=float, default=10, help='Coverage threshold')
    parser.add_argument('--sample-list', dest="sample_list", metavar="sample_list", nargs="+", default=None, type=str, help="sample list")
    parser.add_argument('-o', '--outdir', dest="output_folder", metavar="output_folder", type=str, default="DaPars_results", help='output folder')
