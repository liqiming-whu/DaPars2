...
def DaPars2_main():
    ...
    parser.add_argument('--wigfiles',dest="wigfiles", metavar="wigfiles", nargs="+", required=True, help='wig files generated by: "bedtools genomecov -ibam *.bam -bga -split -trackline"')
    parser.add_argument('--flagstat-files',dest="flagstat", metavar="flagstat", nargs="+", required=True, help='flagstat files generated by: "samtools flagstat *.bam", only pair-end support')
