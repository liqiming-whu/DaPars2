...
def De_Novo_3UTR_Identification_Loading_Target_Wig_for_TCGA_Multiple_Samples_Multiple_threads_Main3_shared_list(
    # argv=None,
    Chroms_file, All_Sample_files, output_folder, Annotated_3UTR_file, Output_result_file, sequencing_depth_file, Num_threads, Coverage_threshold
    ):
...
def DaPars2_Multi_Sample_Multi_Chr():
    ...
    parser.add_argument('-d', '--depth', dest="sequencing_depth_file", required=True, type=str, help='sequencing depth file')
    parser.add_argument('-t', '--threads', dest="Num_threads", type=int, default=4, help='Number of threads')
    parser.add_argument('-p', '--pass', dest="Coverage_threshold", type=float, default=10, help='Coverage threshold')
    args = parser.parse_args()
    De_Novo_3UTR_Identification_Loading_Target_Wig_for_TCGA_Multiple_Samples_Multiple_threads_Main3_shared_list(*vars(args).values())
    

if __name__ == '__main__':
    # De_Novo_3UTR_Identification_Loading_Target_Wig_for_TCGA_Multiple_Samples_Multiple_threads_Main3_shared_list(sys.argv)
    DaPars2_Multi_Sample_Multi_Chr()